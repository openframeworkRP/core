...
/// </summary>
public partial class DamageTracker : Component, IGameEventHandler<DamageTakenGlobalEvent>, IGameEventHandler<PlayerSpawnedEvent>
{
	[Property] public bool ClearBetweenRounds { get; set; } = true;
	[Property] public bool ClearOnRespawn { get; set; } = false;

	public Dictionary<Client, List<OpenFramework.Systems.Pawn.DamageInfo>> Registry { get; set; } = new();
	public Dictionary<Client, List<OpenFramework.Systems.Pawn.DamageInfo>> MyInflictedDamage { get; set; } = new();
	...
	public List<OpenFramework.Systems.Pawn.DamageInfo> GetDamageOnMe()
	{
		return GetDamageInflictedTo( Client.Local );
	}

	public List<OpenFramework.Systems.Pawn.DamageInfo> GetDamageInflictedTo( Client player )
	{
		if ( !Registry.TryGetValue( player, out var list ) )
		{
			return new List<OpenFramework.Systems.Pawn.DamageInfo>();
		}

		return list;
	}

	public List<OpenFramework.Systems.Pawn.DamageInfo> GetMyInflictedDamage( Client player )
	{

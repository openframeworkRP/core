...
public class CameraScope : Component
{
	...
	protected override void OnPreRender()
	{
		...
		if ( Equipment.IsValid() && Equipment.HasTag( "aiming" ) )
		{
			...
			// Ralentissement de la souris basé sur le zoom actuel
			float zoomLevel = RenderCamera.FieldOfView.Remap( 10, 30, 0, 1 );
			Equipment.Owner.AimDampening /= (2.0f - zoomLevel);
		}

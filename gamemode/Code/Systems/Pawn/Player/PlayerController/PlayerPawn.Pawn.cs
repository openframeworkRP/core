...
public partial class PlayerPawn
{
	...
	/// What are we called?
	/// </summary>
	public override string DisplayName => (IsNpc ? "NPC" : (Client.IsValid() ? Client.DisplayName : "Invalid Player"));

	/// <summary>
	/// Is the player controlled by us?
	/// </summary>
	public override bool IsLocallyControlled => base.IsLocallyControlled && !IsNpc;
	...
	public override void OnPossess()
	{
		...
		if ( spectateSystem.IsValid() && ( IsProxy || ( Client.IsValid() && IsNpc) ) )
		{

...
public class CharacterController : Component
{
	...
	private float _defaultRadius = -1f;

	public void SetTemporaryRadius( float extraRadius )
	{
		// On sauvegarde le rayon de base la première fois
		if ( _defaultRadius < 0 ) _defaultRadius = Radius;

		Radius = _defaultRadius + extraRadius;
	}

...
public interface IBehaviorNode
{
	...
	/// </summary>
	NodeResult Evaluate( NpcContext context );
}
...
public abstract class BaseBehaviorNode : IBehaviorNode
{
	...
	public NodeResult Evaluate( NpcContext context )
	{
		// subclasses implement their own synchronous evaluation
		return OnEvaluate( context );
	}

	protected abstract NodeResult OnEvaluate( NpcContext context );
}
...
{
	public NpcPawnController Controller { get; }
	public PlayerPawn Pawn => Controller.Pawn;
	...
	public NpcContext( NpcPawnController controller )
	{

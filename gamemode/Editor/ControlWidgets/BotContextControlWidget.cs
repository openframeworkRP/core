...
[CustomEditor( typeof( NpcContext ) )]
public class NpcContextControlWidget : ControlWidget
{
	...
	public NpcContextControlWidget( SerializedProperty property ) : base( property )
	{
	...
	private void Rebuild()
	{
		...
		_context = SerializedProperty.GetValue<NpcContext>();
		if ( _context == null )
			return;

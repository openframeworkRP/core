...
file sealed class ShootWeaponDebugWidget : Widget
{
	...
	public void UpdateGrid()
	{
		...
		var hitboxConifgs = Constants.Instance.Hitboxes;
		...
		for ( var i = 0; i < Cases.Length; i++ )
		{
			...
			Constants.GetDamageModifications( flags, damageCase.HitboxTags,
				Resource.ArmorReduction ?? Constants.Instance.BaseArmorReduction,
				Resource.HelmetReduction ?? Constants.Instance.BaseHelmetReduction,

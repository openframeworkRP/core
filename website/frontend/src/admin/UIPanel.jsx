...
export default function UIPanel() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#161a26' }}>
      {/* Toolbar */}
      <div style={{
        display: 'flex', alignItems: 'center', gap: 8,
        padding: '8px 12px', background: '#242424', borderBottom: '1px solid #333', flexShrink: 0,
      }}>
        <span style={{ fontWeight: 600, color: '#e8eaed', fontSize: 14, flex: 1 }}>Figma</span>
        {url && (
        ...
        <div onClick={() => url && setShowConfig(false)}
          ...
          <div onClick={e => e.stopPropagation()}
            ...
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
              <span style={{ fontWeight: 600, color: '#e8eaed', flex: 1 }}>URL d'embed Figma</span>
            ...
            <input
              ...
              style={{
                ...
                border: '1px solid #555', background: '#161a26', color: '#e8eaed',

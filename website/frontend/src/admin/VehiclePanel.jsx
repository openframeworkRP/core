...
export default function VehiclePanel() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: 'calc(100vh - 140px)', background: '#1a1a1a' }}>
      {/* Toolbar */}
      <div style={{
        display: 'flex', alignItems: 'center', gap: 8,
        padding: '8px 12px', background: '#242424', borderBottom: '1px solid #333', flexShrink: 0,
      }}>
        <span style={{ fontWeight: 600, color: '#e8e0d0', fontSize: 14, flex: 1 }}>Vehicle Prefab Generator</span>
